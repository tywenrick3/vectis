...
In addition to the primary hook, generate 2-3 hook_variants — alternative opening lines for A/B testing. Each must use a different angle (number-led, bold claim, contrast, consequence) but still lead with a specific fact. All hooks must be 2-3 seconds when spoken.
